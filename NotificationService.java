...
public final class NotificationService {
    ...
    public NotificationService(List<Notifier> channels, Priority threshold) {
        ...
        if(channels == null) throw new IllegalArgumentException("must be not null");
        for(Notifier c : channels) 
        if(c == null ) throw new IllegalArgumentException("");
        if(threshold == null) throw new IllegalArgumentException("must be not null");
    ...
    public boolean broadcast(String message, Priority priority) {
        ...
        if(message == null || message == "") throw new IllegalArgumentException("must be not null") ;
        if(priority == null) throw new IllegalArgumentException("must be not null");
