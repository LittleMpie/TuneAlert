...
public final class Song {
     ...
     * @param tags แท็กของเพลง
     * @throws IllegalArgumentExeption เมื่อ title , artist เป็น null หรือ ช่องว่าง
     */
    public Song(String title, String artist, List<String> tags) {
        ...
        if(title == null || title == "") throw new IllegalArgumentException("title must not be null ");
        if (artist == null || artist == "" ) throw new IllegalArgumentException("artist must not be null");
        if(tags==null) throw new IllegalArgumentException("tags must not be null");
        for(String t : tags)
